"""
Django settings for pedidosMP project.
...
from .passwords import secret_key, pass_bd
...
INSTALLED_APPS = [
    ...
    'pedidosApp.apps.PedidosappConfig',
    'rest_framework',
    'corsheaders',
...
WSGI_APPLICATION = 'pedidosMP.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,                   # Genera nuevo refresh token en cada refresh
